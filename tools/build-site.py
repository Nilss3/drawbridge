...
FAQ = {
    "en": dict(
        ...
        blocks=[
            ...
            ("h4", "Removing it"),
            ("p", "How you remove drawbridge depends on the mode. In <strong>trial mode</strong>, unlock it, press \"Deactivate drawbridge\" on the card at the top of the app, and uninstall it. Nothing on the phone is lost."),
    ...
    "nl": dict(
        ...
        blocks=[
            ...
            ("h4", "Verwijderen"),
            ("p", "Hoe je drawbridge verwijdert hangt af van de modus. In de <strong>proefmodus</strong> ontgrendel je het, druk je op \"Drawbridge uitschakelen\" op de kaart bovenaan de app, en verwijder je het. Er gaat niets verloren op de telefoon."),
    ...
    "fr": dict(
        ...
        blocks=[
            ...
            ("p", "La façon de retirer drawbridge dépend du mode. En <strong>mode d'essai</strong>, déverrouillez-le, appuyez sur « Désactiver drawbridge » sur la carte en haut de l'application, et désinstallez-le. Rien n'est perdu sur le téléphone."),
