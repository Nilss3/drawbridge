...
HOME = {
    "en": dict(
        ...
        good_text="Google Pixel, Samsung, Motorola, OnePlus, Nothing Phone, Fairphone, Sony, Nokia/HMD, the Dumber Mini (LineageOS), Pixel phones with GrapheneOS, and many more.",
    ...
    "nl": dict(
        ...
        good_text="Google Pixel, Samsung, Motorola, OnePlus, Nothing Phone, Fairphone, Sony, Nokia/HMD, de Dumber Mini (LineageOS), Pixel-telefoons met GrapheneOS, en vele andere.",
    ...
    "fr": dict(
        ...
        good_text="Google Pixel, Samsung, Motorola, OnePlus, Nothing Phone, Fairphone, Sony, Nokia/HMD, le Dumber Mini (LineageOS), les Pixel sous GrapheneOS, et bien d'autres.",
...
INSTALL = {
    "en": dict(
        ...
        new_steps=[
            "<strong>Go through Android's setup and skip signing in.</strong> If the phone is already past setup with accounts on it, choose the second situation in the menu above instead.",
        ],
        new_steps_2=[
        ...
        new_steps_3=[
            "Connect the phone to a computer with a USB cable, and press the install button below.",
        ],
        ...
        skip_shots_title="Skipping the sign-in during setup",
        skip_shots=[
            "Android offers to find accounts by phone number. Tap Skip.",
            "The Google sign-in screen comes next. Tap Skip again.",
            "Confirm with Skip. You sign in at the end, once drawbridge is on.",
        ],
        ...
        cable_steps=[
            ...
            "Plug the phone in and press the install button below.",
        ],
        ...
        installer_h2="Install from your browser",
        installer_intro="This installs drawbridge onto the phone plugged into this computer. Nothing is uploaded anywhere: the app is served from this site and goes straight down the cable.",
        fallback='If your browser cannot do it, the same install is one command from a copy of the repository, <code>tools/provision-adb.sh</code>, which installs both apps and makes drawbridge the owner of the phone. It is documented in <a href="https://github.com/Nilss3/drawbridge/blob/main/docs/provisioning.md">provisioning.md</a>.',
    ...
    "nl": dict(
        ...
        flow_labels=[
            "Installeren op een nieuwe telefoon, of na een factory reset",
            "Installeren op een telefoon die al in gebruik is",
            "Een telefoon bijwerken die drawbridge al heeft",
        ],
        ...
        new_steps=[
            "<strong>Doorloop de setup van Android en sla het aanmelden over.</strong> Staat de telefoon al voorbij de setup met accounts erop, kies dan hierboven het tweede geval.",
        ],
        new_steps_2=[
        ...
        new_steps_3=[
            "Verbind de telefoon met een computer via een USB-kabel, en druk hieronder op de installatieknop.",
        ],
        ...
        skip_shots_title="Het aanmelden overslaan tijdens de setup",
        skip_shots=[
            "Android wil accounts zoeken via je telefoonnummer. Tik op Overslaan.",
            "Daarna komt het aanmeldscherm van Google. Tik opnieuw op Overslaan.",
            "Bevestig met Overslaan. Aanmelden doe je op het einde, als drawbridge erop staat.",
        ],
        ...
        cable_steps=[
            ...
            "Verbind de telefoon en druk hieronder op de installatieknop.",
        ],
        ...
        installer_h2="Installeren vanuit je browser",
        installer_intro="Dit installeert drawbridge op de telefoon die aan deze computer hangt. Er wordt niets geüpload: de app komt van deze site en gaat rechtstreeks door de kabel.",
        fallback='Kan je browser het niet, dan is dezelfde installatie één commando vanuit een kopie van de repository, <code>tools/provision-adb.sh</code>, dat beide apps installeert en drawbridge de eigenaar van de telefoon maakt. De uitleg staat in <a href="https://github.com/Nilss3/drawbridge/blob/main/docs/provisioning.md">provisioning.md</a>.',
    ...
    "fr": dict(
        ...
        flow_labels=[
            "Installer sur un téléphone neuf, ou après une réinitialisation",
            "Installer sur un téléphone déjà utilisé",
            "Mettre à jour un téléphone qui a déjà drawbridge",
        ],
        ...
        new_steps=[
            "<strong>Suivez la configuration d'Android et sautez la connexion.</strong> Si le téléphone a déjà terminé sa configuration avec des comptes dessus, choisissez plutôt le deuxième cas dans le menu ci-dessus.",
        ],
        new_steps_2=[
        ...
        new_steps_3=[
            "Connectez le téléphone à un ordinateur avec un câble USB, et appuyez sur le bouton d'installation ci-dessous.",
        ],
        ...
        skip_shots_title="Sauter la connexion pendant la configuration",
        skip_shots=[
            "Android propose de chercher des comptes via votre numéro. Touchez Ignorer.",
            "L'écran de connexion Google suit. Touchez de nouveau Ignorer.",
            "Confirmez avec Ignorer. Vous vous connecterez à la fin, une fois drawbridge en place.",
        ],
        ...
        cable_steps=[
            ...
            "Branchez le téléphone et appuyez sur le bouton d'installation ci-dessous.",
        ],
        ...
        installer_h2="Installer depuis votre navigateur",
        installer_intro="Ceci installe drawbridge sur le téléphone relié à cet ordinateur. Rien n'est téléversé où que ce soit : l'application vient de ce site et passe directement par le câble.",
        fallback='Si votre navigateur ne le peut pas, la même installation tient en une seule commande depuis une copie du dépôt, <code>tools/provision-adb.sh</code>, qui installe les deux applications et fait de drawbridge le propriétaire du téléphone. Tout est expliqué dans <a href="https://github.com/Nilss3/drawbridge/blob/main/docs/provisioning.md">provisioning.md</a>.',
...
# ---------------------------------------------------------------------------
# The installer's own half of the install page: the button, the progress list,
# and what to do on the phone once it finishes. WebUSB cannot be done without
# JavaScript, so /install/ is the one page on this site that runs any.
# Everything it loads is same-origin, including the APK, so the "nothing leaves
# the device" posture holds even here.
#
# Kept apart from INSTALL because the two answer different questions. INSTALL is
# the guide, and it is the half that changes when the preparation changes; this
# is the machinery, and its wording is tied to what installer.js actually does.
# ---------------------------------------------------------------------------

INSTALLER = {
    "en": dict(
        redirect_title="Install over USB · drawbridge",
        redirect_description="The USB installer now lives on the install page itself.",
        redirect_text="The USB installer is now part of the install page.",
        redirect_link="Go to the install page",
    ...
    "nl": dict(
        redirect_title="Installeren via USB · drawbridge",
        redirect_description="De USB-installer staat nu op de installatiepagina zelf.",
        redirect_text="De USB-installer maakt nu deel uit van de installatiepagina.",
        redirect_link="Naar de installatiepagina",
        ...
        update_done_steps=[
            "Open <strong>drawbridge</strong>. De nieuwe versie kun je nakijken onder ⋮ → Diagnostics.",
            "Tik op <strong>drawbridge vergrendelen</strong> en schrijf de sleutel op die verschijnt. Bij elke vergrendeling wordt een nieuwe gemaakt, dus je vorige sleutel werkt niet meer.",
        ],
        ...
        done_note="Bij het vergrendelen gaat USB-debugging uit. Ze komt terug zodra je drawbridge met je sleutel ontgrendelt. Zo installeer je later een nieuwere versie via dezelfde kabel.",
        source_note='Deze pagina draait <a href="https://github.com/Nilss3/drawbridge/tree/main/site-src/installer">een kleine ADB-client</a> in je browser. Ze zet de controle van Android op kabelinstallaties even uit, alleen zolang het kopiëren duurt, en zet ze daarna precies terug zoals ze was: bij succes, bij mislukking, en als je de telefoon loskoppelt.',
    ),
    "fr": dict(
        redirect_title="Installer par USB · drawbridge",
        redirect_description="L'installeur USB se trouve désormais sur la page d'installation elle-même.",
        redirect_text="L'installeur USB fait maintenant partie de la page d'installation.",
        redirect_link="Aller à la page d'installation",
...
# Screenshots of the phone screens the preparation runs through.
#
# **Pictures because the words were not enough and could not be made enough.**
# Each of these steps is a path through a screen the reader has never been told
# to look at, and Settings is where every manufacturer diverges: the entry they
# are looking for is worded differently on a Motorola than on a Nothing, sits at
# a different depth, and on the accounts screen the important part is not a path
# at all but *what the list contains*, that Signal and WhatsApp are accounts on
# it, which no wording makes as obvious as one look at the screen does.
#
# **The `skip` set is the one a new phone needs and the other two are not.** A
# phone out of the box has no accounts to remove; what it has is a setup wizard
# that asks twice to sign in and hides the way past it behind a confirmation
# dialog. Until 2026-08-25 the new-device flow showed the account-*removal*
# pictures, which is the opposite instruction, illustrated.
#
...
#
# The skip-account three are photographs of a phone mid-setup rather than
# screencaps, because the setup wizard on this device would not take one. They
# are trimmed to the screen, then padded on the axis that is short, so nothing
# in them is ever cropped away:
#
#   magick images/skip-account-1.jpg -fuzz 28% -trim +repage -shave 8x8 +repage \
#       -background "srgb(21,21,23)" -gravity center -extent 907x2008 \
#       -resize 480x -quality 82 site/assets/img/step-skip-1.webp

SHOT_SETS = dict(
    skip=("step-skip-1.webp", "step-skip-2.webp", "step-skip-3.webp"),
...
def render_install(lang: str, apk: dict) -> str:
    """The install guide: three situations behind one dropdown, then the installer.
    ...
    **Three flows rather than one, as of 2026-08-24**, because the page had been
    ...
    "do not sign in during setup", advice the old page could not give, because it
    was busy telling everyone to remove accounts it assumed were there. A phone
    that already has drawbridge does not want any of this: it wants to be told
    the app has a button.

    **One page rather than two, as of 2026-08-25.** The installer lived next door
    at /install/usb/ and repeated its own shorter, staler copy of the
    preparation: one list of steps for every situation, no pictures, and an
    account instruction a new phone should never follow. Two pages meant the
    three flows and the screenshots had to exist twice or be wrong once, and they
    were wrong once. The guide now ends at the button that does the work, and
    /install/usb/ is a redirect, because that URL is what has been handed out.

    **What the dropdown does not hide is the caveat about apps disappearing.** It
    ...
    **The steps stop at the cable, and putting the accounts back comes after the
    ...
    an instruction to undo the step before it.

    **The picker is a select and eleven lines of script, and every panel is in
    the HTML.** With script off the reader gets all three flows in order under
    their own headings, which is the honest failure mode; with it on, the
    headings go visually hidden because the dropdown right above them already
    says which flow this is. A URL fragment (/install/#used) picks a flow, so
    somebody can be pointed at the one that applies to them.
    """
    c = INSTALL[lang]
    t = INSTALLER[lang]
    prefix = lang_prefix(lang)
...
{shot_strip(c, "devopts", only=(3, 4))}
    ...
    step_items = "\n".join(
        ...
        for i, label in enumerate(t["step_labels"])
    )
  ...
  <section class="section">
    <div class="wrap">
      ...
      <div class="flow-picker" id="flow-picker">
        <label class="flow-legend" for="flow-select">{c['picker_legend']}</label>
...
{panels}
      ...
      <h2 id="installer">{c['installer_h2']}</h2>
      <p>{c['installer_intro']}</p>
      <p class="footnote">{t['browser_note']}</p>

      <div class="callout" id="installer-unsupported" hidden>
        <p style="margin:0;">{t['unsupported']}</p>
      </div>

      <div class="btn-row">
        <button class="btn btn--primary" id="installer-start" type="button">{t['start_button']}</button>
      </div>
...
{step_items}
      ...
      <div id="installer-done-update" hidden>
        <h2>{t['update_done_h2']}</h2>
        {steps_html(t['update_done_steps'])}
        <p class="footnote">{t['done_note']}</p>
      </div>

      <div id="installer-done" hidden>
        <h2>{t['done_h2']}</h2>
        {steps_html(t['done_steps'])}
        <p class="footnote">{t['done_note']}</p>
      </div>

      <p class="footnote">{t['source_note']}</p>
      <p class="footnote">{c['fallback']}</p>
...
"""
    ...
    scripts = f"""<script>
// The flow picker. Panels start visible so a reader with no script gets all
// three; this hides the other two and lets the dropdown swap between them.
(function () {{
  var picker = document.getElementById("flow-picker");
  var select = document.getElementById("flow-select");
  if (!picker || !select) return;
  var keys = {json.dumps(list(keys))};
  function show(key) {{
  ...
  function fromHash() {{
    ...
    if (keys.indexOf(wanted) === -1) return false;
    select.value = wanted;
    show(wanted);
    return true;
  }}
  picker.dataset.js = "on";
  select.addEventListener("change", function () {{
    show(select.value);
    history.replaceState(null, "", "#" + select.value);
  }});
  // A link to /install/#update from another page on this site never reloads
  // anything if the reader is already here, so the hash has to be watched as
  // well as read once.
  window.addEventListener("hashchange", fromHash);
  if (!fromHash()) show(select.value);
}}());
</script>
<script type="module">
...
init({{
  ...
  apkName: "{apk['name']}",
  text: {{ updateDetected: {json.dumps(t['update_detected'])} }},
}});
</script>
"""
    return render_page(
...
def render_usb_redirect(lang: str) -> str:
    """/install/usb/, which is now a signpost to /install/.

    The installer used to live here and the guide lived next door, and this is
    the URL that got written down: it is in docs/handoff.md, it is what has been
    sent to the people testing this, and it is what the app's own update screen
    used to point at. Deleting it would turn all of that into a 404 for the sake
    of tidiness.

    A meta refresh rather than a `_redirects` file, because that file is a
    Cloudflare Pages feature and this has to work the same from the local
    preview server, from a saved copy, and from whatever this is served by next.
    The visible link underneath is what a reader gets if the refresh is blocked.
    """
    t = INSTALLER[lang]
    target = f"{lang_prefix(lang)}/install/"
    return f"""<!doctype html>
<html lang="{lang}">
<head>
<!-- Generated by tools/build-site.py from site-src/. Do not hand-edit; rerun the build script instead. -->
<meta charset="utf-8" />
<title>{t['redirect_title']}</title>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="description" content="{t['redirect_description']}" />
...
<main>
  <section class="section">
    <div class="wrap">
      <p>{t['redirect_text']}</p>
      <p><a href="{target}">{t['redirect_link']}</a></p>
    </div>
  </section>
</main>
</body>
...
FAQ = {
    "en": dict(
        ...
        blocks=[
            ...
            ("ul", [
                "<strong>Trial mode, unlocked:</strong> switch drawbridge off with the button on the app's trial-mode card, then uninstall it. A factory reset works too.",
            ...
            ("h4", "Removing it"),
            ("p", "How you remove drawbridge depends on the mode. In <strong>trial mode</strong>, unlock it, press \"Deactivate drawbridge to uninstall\" on the card at the top of the app, and uninstall it. Nothing on the phone is lost."),
    ...
    "nl": dict(
        ...
        blocks=[
            ...
            ("ul", [
                "<strong>Proefmodus, ontgrendeld:</strong> zet drawbridge uit met de knop op de proefmoduskaart in de app en verwijder het. Een factory reset kan ook.",
            ...
            ("h4", "Verwijderen"),
            ("p", "Hoe je drawbridge verwijdert hangt af van de modus. In de <strong>proefmodus</strong> ontgrendel je het, druk je op \"Drawbridge uitschakelen om te verwijderen\" op de kaart bovenaan de app, en verwijder je het. Er gaat niets verloren op de telefoon."),
    ...
    "fr": dict(
        ...
        blocks=[
            ...
            ("ul", [
                "<strong>Mode d\'essai, déverrouillé :</strong> désactivez drawbridge avec le bouton de la carte « mode d\'essai » de l\'application, puis désinstallez-le. Une réinitialisation d\'usine fonctionne aussi.",
            ...
            ("p", "La façon de retirer drawbridge dépend du mode. En <strong>mode d'essai</strong>, déverrouillez-le, appuyez sur « Désactiver drawbridge pour le désinstaller » sur la carte en haut de l'application, et désinstallez-le. Rien n'est perdu sur le téléphone."),
...
def build_all() -> None:
    ...
    for lang in LANGUAGES:
        ...
        write(base / "install" / "index.html", render_install(lang, apk))
        write(base / "install" / "usb" / "index.html", render_usb_redirect(lang))
