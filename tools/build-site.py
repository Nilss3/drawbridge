...
INSTALL = {
    "en": dict(
        ...
        alpha_detail="This public alpha has been tested on two devices by the people who built it: a Motorola G15 and a Nothing Phone (3a), the second of which is a daily phone and runs it without trouble. It works end to end on both. Nothing is known about how it behaves on any other phone, so don't use a device you depend on.",
    ...
    "nl": dict(
        ...
        alpha_detail="Deze publieke alfa is door de makers zelf op twee toestellen getest: een Motorola G15 en een Nothing Phone (3a), waarvan die laatste een dagelijkse telefoon is die er zonder problemen op draait. Op allebei werkt ze van begin tot eind. Over het gedrag op eender welke andere telefoon is niets bekend, dus gebruik geen toestel waar je van afhangt.",
    ...
    "fr": dict(
        ...
        alpha_detail="Cette alpha publique a été testée sur deux appareils par ceux qui l'ont construite : un Motorola G15 et un Nothing Phone (3a), ce dernier étant un téléphone du quotidien sur lequel elle tourne sans problème. Elle fonctionne de bout en bout sur les deux. On ne sait rien de son comportement sur un autre téléphone, donc n'utilisez pas un appareil dont vous dépendez.",
