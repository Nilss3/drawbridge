...
# The device admin receiver is named in the provisioning command and QR payload,
# so its class name must survive minification exactly.
-keep class app.drawbridge.dpc.admin.DrawbridgeDeviceAdminReceiver { *; }
